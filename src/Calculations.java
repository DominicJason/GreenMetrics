...
public class Calculations {
    ...
    private JTextField outputTextField4;
    ...
    public Calculations() {
        ...
        outputTextField4 = new JTextField();
        outputTextField4.setEditable(false);
    ...
    public void calculate() {
        ...
        double carbonFootPrint = gasolineLitres*2.68;
        // Update the outputTextField with the calculated total distance
        outputTextField1.setText("Total Distance Driven: " + round(totalKilometersDriven) + " km");
        outputTextField2.setText("Total Gasoline used: " + round(gasolineLitres) + "L");
        outputTextField3.setText("Total Money spent on Gasoline: " + round(moneySpent) + "฿");
        outputTextField4.setText("Total CO2 emission: " + round(carbonFootPrint) + "Kg");
    }
